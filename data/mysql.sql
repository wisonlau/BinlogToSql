INSERT INTO `test`.`student` SET id=1 name='wisonlau' age=20 class=1
UPDATE `test`.`student` id=1 name='wisonlau' age=20 class=1 SET id=1 name='wisonlau' age=18 class=1
